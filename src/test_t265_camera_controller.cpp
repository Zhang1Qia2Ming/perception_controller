                ...
                for(const auto& interface : state_interfaces_) {
                    if(interface.get_interface_name() == "data_ptr") {
                        ...
                        if (t265_camera_data) {
                            ...
                            msg->pose.position.x = t265_camera_data->pose.translation[0];
                            msg->pose.position.y = t265_camera_data->pose.translation[1];
                            msg->pose.position.z = t265_camera_data->pose.translation[2];
